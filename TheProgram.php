...
<main style="background-color: lightgray">
    ...
    <div class="row">
        <div style="padding: 20px 50px 20px 50px">
            ...
            <div style="padding: 0 30px 0 100px">
                <p>The Legacy to Mobile (L2M) program provides a unique experience in developing and supporting computer
                    systems
                    to satisfy business requirements. Graduates are well trained for a career as a programmer analyst or
                    as
                    technical support. Students will also benefit from excellent on-site training at companies, which
                    may
                    lead
                    to full-time jobs.</p>
                <p>
                    Our courses are constantly evolving to meet the needs of employers. Learning takes place in both the
                    classrooms and computer labs. Our teachers bring sound knowledge and experience to the classroom.
                    This
                    three-year program is well-suited for students who are interested in computer programming. Champlain
                    has
                    become one of the few cégeps in Quebec to offer mainframe programming and, through our partnership
                    with
                    the well established Fresche Legacy, students will have access to mainframe resources. In addition,
                    students will focus on IT modernization solutions, which include programming for mobile platforms
                    such
        ...
        <div class="row semester" id="semester2">
            ...
            <div class="col-xs-10">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        <ul>
                            <li>Quantitative Methods fro Computer Science</li>
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <ul>
                            ...
                            <li>Comprehensive Assessment / <br>Digital Portfolio</li>
                        </ul>
                    </div>
                    <div class="col-xs-5">
